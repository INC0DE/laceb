  ...
  return (
    <section>
      <div>
        ...
        <div className="flex flex-row gap-5 justify-center py-10">
          {cards.map((items) => (
            <Card key={items.id} className="w-80 h-64 p-10 group flex flex-col gap-4 hover:bg-blue">
              {items.icon}
              <h1 className="text-blue text-5xl font-medium group-hover:text-white">{items.title}</h1>
              <div className="flex flex-row">
                <div className="h-24 w-2 bg-orange group-hover:bg-green"></div>
                <p className="self-center ml-2 text-center text-sm group-hover:text-white">{items.description}</p>
              </div>
            </Card>
          ))}
        </div>
      ...
      <div className="py-10">
        <div className="text-7xl text-center p-10">
          <h1 className="">
            En{" "}
            <span className="text-8xl font-semibold text-blue">
              LACEB S.A DE C.V
            </span>{" "}
          </h1>
          <h1 className="">
            somos fieles a nuestros{" "}
            <span className="text-8xl font-semibold">VALORES</span>{" "}
          </h1>
        </div>
        ...
        <div className="flex flex-row justify-around py-10">
          {valores.map((items) => (
            <Card
              key={items.id}
              className="w-72 h-56 justify-center items-center space-y-4 hover:bg-green"
            >
