...
const Introduction = () => {
  return (
    <div className="bg-blue flex flex-col gap-20 px-3 lg:px-10 py-16">
      <div className="flex flex-col text-white">
        <h1 className="text-5xl lg:text-7xl">Mantenimiento y</h1>
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:justify-around">
        {cards.map((items) => (
          <Card
            key={items.id}
            className="lg:w-80 lg:h-72 flex flex-col gap-5 justify-center p-10"
          >
